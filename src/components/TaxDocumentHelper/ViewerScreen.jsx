...
export default function ViewerScreen({ fileName, onBack, activeN, onBoxClick }) {
  return (
    <div className="mx-auto max-w-[1040px] px-8 pt-[26px] pb-[90px]">
      ...
      <div className="mb-[26px] flex max-w-[608px] items-center gap-[14px] rounded-2xl border border-dm-line bg-dm-accent-soft px-[18px] py-[15px]">
        ...
        <div>
          ...
          <div className="mt-0.5 text-sm text-dm-muted">Tap any highlighted box to hear a simple explanation.</div>
        </div>
      </div>

      <div className="flex items-start">
        <W2Document activeN={activeN} onBoxClick={onBoxClick} />
      </div>
    </div>
  );
}
